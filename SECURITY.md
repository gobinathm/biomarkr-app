...
Instead, please report security vulnerabilities to: **security@biomarkr.com**
...
### **Security Team**
- **Email**: security@biomarkr.com
- **PGP Key**: [Available on keyservers]
- **Response Time**: 48 hours maximum

### **General Contact**
- **Support**: support@biomarkr.com
- **Privacy**: privacy@biomarkr.com
- **Compliance**: compliance@biomarkr.com
